...
export function LastOverTracker({ ballEvents, legalBalls }: LastOverTrackerProps) {
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/[0.04] backdrop-blur-sm p-4 shadow-sm space-y-2.5">
      <h3 className="text-xs font-bold text-slate-300 uppercase tracking-wider">Last Over</h3>
