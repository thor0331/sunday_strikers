...
export function WicketDialogTest() {
  ...
  return (
    <div className="max-w-md mx-auto p-4 space-y-4">
      <h2 className="text-lg font-bold text-slate-50">Wicket Dialog Test</h2>
      ...
      {showWicketForm && (
        ...
        >
          <h3 className="font-bold text-red-400">Log Wicket</h3>
          ...
          <label className="grid gap-1 text-sm font-medium">
            ...
            <select
              ...
              required
              className="min-h-11 rounded-lg border border-white/15 bg-[#0F1B2D] px-3 text-slate-200"
            >
          ...
          <div className="flex gap-2 mt-2">
            ...
            <button
              ...
              className="rounded-lg bg-white/10 text-slate-200 px-4 py-2 font-bold hover:bg-white/15"
            >
              Cancel
            </button>
          </div>
